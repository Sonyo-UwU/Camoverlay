...
export async function addAllianceButtonBack() {
    ...
    while (buttonList === undefined || buttonList.childElementCount !== 4) {
        await new Promise(r => setTimeout(r, 100));
        buttonList = document.getElementsByClassName('flex flex-col items-center gap-3')[0];
    }

    buttonList.firstElementChild?.insertAdjacentHTML('afterend',
        '<button id="ca-alliance" class="btn btn-square shadow-md" title="Alliance">' +
